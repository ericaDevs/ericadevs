...
# Default True locally so tracebacks are visible; Render sets DEBUG=False via env.
...
# Explicitly configure the Cloudinary SDK so uploads work correctly.
# django-cloudinary-storage 0.3.0 does NOT always auto-sync CLOUDINARY_STORAGE
# into the underlying cloudinary package config, causing silent upload failures.
...
# Storage Backend Handlers (Django 4.2+)
STORAGES = {
    "default": {
